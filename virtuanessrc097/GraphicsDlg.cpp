...
//	DEBUGOUT( "CGraphicsDlg::OnOK\n" );
	...
	INT sel = (INT)::SendDlgItemMessage( m_hWnd, IDC_GRA_RESOLUTION_COMBO, CB_GETCURSEL, 0, 0 );
	INT no  = (INT)::SendDlgItemMessage( m_hWnd, IDC_GRA_RESOLUTION_COMBO, CB_GETITEMDATA, (WPARAM)sel, 0 );
