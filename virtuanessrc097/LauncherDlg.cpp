...
void	CLauncherDlg::OnUpdateStart()
{
	...
	if( m_bUpdate ) {
		...
		m_UpdatePos = 0;
		m_nUpdateIndex = 0;
		m_nTimerID = (INT)::SetTimer( m_hWnd, 1, 100, NULL );
		m_bUpdate = TRUE;
	}
}
...
//	DEBUGOUT( "CLchDispEditDlg::OnAdd\n" );
	...
	INT nSel = (INT)::SendDlgItemMessage( m_hWnd, IDC_DED_HIDELIST, LB_GETCURSEL, 0, 0 );
...
//	DEBUGOUT( "CLchDispEditDlg::OnDel\n" );
	...
	INT nSel = (INT)::SendDlgItemMessage( m_hWnd, IDC_DED_VIEWLIST, LB_GETCURSEL, 0, 0 );
