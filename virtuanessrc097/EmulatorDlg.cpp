...
//	DEBUGOUT( "CEmulatorDlg::OnHScroll\n" );
	...
	INT pos = (INT)::SendDlgItemMessage( m_hWnd, IDC_EMU_THROTTLE_SLIDER, TBM_GETPOS, 0, 0 );
	CHAR	str[16];
...
//	DEBUGOUT( "CEmulatorDlg::OnOK\n" );
	...
	Config.emulator.nThrottleFPS = 10 * (INT)::SendDlgItemMessage( m_hWnd, IDC_EMU_THROTTLE_SLIDER, TBM_GETPOS, 0, 0 );
