...
//	DEBUGOUT( "CAviConvDlg::OnConvertStart\n" );
	...
	INT select = (INT)::SendDlgItemMessage( m_hWnd, IDC_MCV_FRAMERATE_COMBO, CB_GETCURSEL, 0, 0 );
	...
	select = (INT)::SendDlgItemMessage( m_hWnd, IDC_MCV_SAMPLERATE_COMBO, CB_GETCURSEL, 0, 0 );
